...
use App\Http\Controllers\Api\V1\Content\PageContentController;
...
Route::prefix('v1')->group(function () {
    ...
    // 0) HEALTH / VERSION
    // =========================
    Route::get('health', fn() => response()->json(['success' => true, 'data' => ['status' => 'ok'], 'meta' => (object)[], 'error' => null]));
    Route::get('version', fn() => response()->json(['success' => true, 'data' => ['version' => 'dev'], 'meta' => (object)[], 'error' => null]));
    // =========================
    // 1) AUTH & SESSION
    // =========================
    Route::prefix('auth')->group(function () {
        ...
        // optional security (stub dulu)
        Route::post('verify-email/send', fn() => response()->json(['success'=>true,'data'=>['todo'=>true],'meta'=>(object)[],'error'=>null]));
        Route::post('verify-email/confirm', fn() => response()->json(['success'=>true,'data'=>['todo'=>true],'meta'=>(object)[],'error'=>null]));
        Route::post('password/forgot', fn() => response()->json(['success'=>true,'data'=>['todo'=>true],'meta'=>(object)[],'error'=>null]));
        Route::post('password/reset', fn() => response()->json(['success'=>true,'data'=>['todo'=>true],'meta'=>(object)[],'error'=>null]));
    });
    ...
    Route::get('products/{product}/availability', fn() => response()->json(['success'=>true,'data'=>['available'=>null,'todo'=>true],'meta'=>(object)[],'error'=>null]));
    ...
    // 4) WEBHOOKS (PUBLIC)
    // =========================
    Route::post('webhooks/payments/{gateway_code}', fn() => response()->json(['success'=>true,'data'=>['received'=>true,'todo'=>true],'meta'=>(object)[],'error'=>null]));
    ...
    Route::middleware('auth:sanctum')->prefix('admin')->group(function () {
        Route::middleware('role:admin')->group(function () {
            ...
            // Route::delete('pages/{id}', [Adminx`PageController::class, 'destroy']);
    ...
    Route::middleware('auth:sanctum')->post(
        '/upload/sign',
        [SupabaseUploadController::class, 'sign']
    );
